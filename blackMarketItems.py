...
#Weapons
item111 = weapon("Battleaxe", 10, 1, 3)
item112 = weapon("Blowgun", 10, 1, 3)
item113 = weapon("Boomerang", .1, 1, 3)
item114 = weapon("Club", .1, 1, 3)
item115 = weapon("Crossbow, Hand", 75, 1, 1)
item116 = weapon("Crossbow, Heavy", 50, 1, 1)
item117 = weapon("Crossbow, Light", 25, 1, 3)
item118 = weapon("Dagger", 2, 1, 10)
item119 = weapon("Dart", .05, 10, 30)
item120 = weapon("Double-Bladed Scimitar", 100, 1, 1)
item121 = weapon("Flail", 10, 1, 3)
item122 = weapon("Glaive", 20, 1, 2)
item123 = weapon("Greataxe", 30, 1, 2)
item124 = weapon("Greatclub", .2, 1, 3)
item125 = weapon("Greatsword", 50, 1, 2)
item126 = weapon("Halberd", 20, 1, 3)
item127 = weapon("Handaxe", 5, 1, 2)
item128 = weapon("Javelin", .5, 3, 10)
item129 = weapon("Lance", 10, 1, 3)
item130 = weapon("Light Hammer", 2, 1, 3)
item131 = weapon("Longbow", 50, 1, 3)
item132 = weapon("Longsword", 15, 1, 10)
item133 = weapon("Mace", 10, 1, 3)
item134 = weapon("Morningstar", 15, 1, 3)
item135 = weapon("Net", 1, 1, 3)
item136 = weapon("Pike", 5, 1, 3)
item137 = weapon("Quarterstaff", .2, 1, 3)
item138 = weapon("Rapier", 25, 1, 3)
item139 = weapon("Scimitar", 25, 1, 3)
item140 = weapon("Shortbow", 25, 1, 3)
item141 = weapon("Shortsword", 10, 1, 3)
item142 = weapon("Sickle", 1, 1, 3)
item143 = weapon("Sling", .1, 1, 3)
item144 = weapon("Spear", 1, 1, 3)
item145 = weapon("Trident", 5, 1, 3)
item146 = weapon("War Pick", 5, 1, 3)
item147 = weapon("Warhammer", 15, 1, 3)
item148 = weapon("Whip", 2, 1, 3)
item149 = weapon("Yklwa", 1, 1, 10)

#Armor
item150 = armor("Padded", 5, 1, 3)
item151 = armor("Leather", 10, 1, 3)
item152 = armor("Studded Leather", 45, 1, 3)
item153 = armor("Hide", 10, 1, 3)
item154 = armor("Chain Shirt", 50, 1, 2)
item155 = armor("Scale Mail", 50, 1, 2)
item156 = armor("Breastplate", 400, 1, 2)
item157 = armor("Half Plate", 750, 1, 2)
item158 = armor("Ring Mail", 90, 1, 1)
item159 = armor("Chian Mail", 225, 1, 1)
item160 = armor("Splint", 600, 1, 1)
item161 = armor("Plate", 4500, 1, 1)
item162 = armor("Shield, wooden", 10, 1, 3)
